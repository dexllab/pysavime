...
def example():
    with Client(host='127.0.0.1', port=65000) as client:
        ...
        dataset_b = RangeDataset(dataset_b_name, Range(1, dim_1_len * dim_2_len, 1), SavimeSupportedTypes.FLOAT)
